...
El mensaje será procesado por el sistema web utilizando la información de sesión para proceder. En primer lugar el sistema web obtendrá del sistema de restricciones aquellas que se encuentran vigentes.
...
El administrador de elecciones permitirá también, dada una elección y un claustro, obtener los candidatos que se han postulado en la misma.
Cabe destacar que una misma elección podría estar involucrar a más de un claustro, pero las fechas en todos ellos deberán coincidir.
