...
Tras presenciar el QAW y releer su resumen, decidimos plasmar todos los escenarios separados por categor\'ias. A partir de esto pudimos tomamos decisiones arquitect\'onicas tratando de satisfacer los atributos de calidad relevados.
...
\input{../escenarios/disponibilidad}
\bigskip

\input{../escenarios/performance}
\bigskip

\input{../escenarios/seguridad}
\bigskip

\input{../escenarios/modificabilidad}
\bigskip

\input{../escenarios/usabilidad}
