...
Para verificar que una persona cumple con las reglas establecidas para la votación es necesario consultar el padrón para disponer de la información de dicho votante. 




%%disponibilidad => se pueden tener muchos portales ??
%%disponibilidad => el padrón esta replicado en todos los vox-core para disminuir la carga
%%seguridad
%%modificabilidad => el hard to break es un componente que se puede cambiar facilmente
