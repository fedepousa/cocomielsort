...
\section*{Introducci\'on}
En este problema lo que se quiere es, teniendo un conjunto de personas y sabiendo si se conocen entre s\'i, armar dos grupos de tres personas cada uno, un grupo en el cual las 3 personas se conoscan mutuamente, y otro grupo en el cual ninguno este relacionado con otro.
\section*{Algoritmo}
\section*{Complejidad}
\section*{An\'alisis de resultados}
\section*{Conclusiones}
