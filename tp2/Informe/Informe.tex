...
\begin{figure}[H]
\centering
\subfloat[Izquierda 1]{\includegraphics[width=0.3\textwidth]{imagenes/paso0b.PNG}}
\qquad
\subfloat[Derecha 1]{\includegraphics[width=0.3\textwidth]{imagenes/paso3a.png}}
\caption{Se calcula el matching máximo en los vectores - Primer paso}
\end{figure}

\begin{figure}[H]
\centering
\subfloat[Izquierda 2]{\includegraphics[width=0.3\textwidth]{imagenes/paso1b.PNG}}
\qquad
\subfloat[Derecha 2]{\includegraphics[width=0.3\textwidth]{imagenes/paso4a.png}}
\caption{Se calcula el matching máximo en los vectores - Segundo paso}
\end{figure}

\begin{figure}[H]
\centering
\subfloat[Izquierda 3]{\includegraphics[width=0.3\textwidth]{imagenes/paso2b.PNG}}
\qquad
\subfloat[Derecha 3]{\includegraphics[width=0.3\textwidth]{imagenes/paso5a.png}}
\caption{Se calcula el matching máximo en los vectores - Tercer paso}
\end{figure}

\begin{figure}[H]
\centering
\subfloat[Izquierda 4]{\includegraphics[width=0.3\textwidth]{imagenes/paso3b.png}}
\qquad
\subfloat[Derecha 4]{\includegraphics[width=0.3\textwidth]{imagenes/paso6a.png}}
\caption{Se finaliza un matching, se continúa el cálculo del otro}
\end{figure}

\begin{figure}[H]
\centering
\subfloat[Izquierda 5]{\includegraphics[width=0.3\textwidth]{imagenes/paso4b.png}}
\qquad
\subfloat[Derecha 5]{\includegraphics[width=0.3\textwidth]{imagenes/paso6a.png}}
...
\begin{figure}[H]
\centering
\subfloat[S\'eptimo Paso]{\includegraphics[width=0.2\textwidth]{imagenes/inundPaso7.png}}
\qquad
