...
\begin{figure}[H]
\centering
\scalebox{1.1}{\includegraphics[width=1.0\textwidth]{Imagenes/ModeloConceptual.png}}
...
allInstances()$\rightarrow$select(d$|$d.cantidad$<$d.límite)$\rightarrow$forAll(d$|$d.deposito.local.pedido.intersection(d.ingrediente.pedido).size()$=1$ )    
...
\begin{figure}[H]
\centering
\scalebox{1.0}{\includegraphics[width=1.0\textwidth]{Imagenes/CasosDeUso.png}}
...
\begin{figure}[H]
\centering
\scalebox{1.0}{\includegraphics[width=1.0\textwidth]{Imagenes/DA-Pedido.png}}
...
\begin{figure}[H]
\centering
\scalebox{0.5}{\includegraphics[width=1.0\textwidth]{Imagenes/JefedeChefs.png}}
...
\begin{figure}[H]
\centering
\scalebox{0.3}{\includegraphics[width=1.0\textwidth]{Imagenes/Servidor.png}}
...
\begin{figure}[H]
\centering
\scalebox{0.5}{\includegraphics[width=1.0\textwidth]{Imagenes/Operador.png}}
\caption{Operador}
\end{figure}
