...
\begin{figure}[H]
\centering
\scalebox{1.0}{\includegraphics[width=0.8\textwidth]{Imagenes/CasosDeUso.png}}
...
\begin{figure}[H]
\centering
\scalebox{0.5}{\includegraphics[width=0.9\textwidth]{Imagenes/JefedeChefs.png}}
...
\begin{figure}[H]
\centering
\scalebox{0.3}{\includegraphics[width=0.9\textwidth]{Imagenes/Servidor.png}}
...
\begin{figure}[H]
\centering
\scalebox{0.5}{\includegraphics[width=0.9\textwidth]{Imagenes/Operador.png}}
\caption{Operador}
\end{figure}
