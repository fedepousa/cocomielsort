...
import ubadbtools.deadlockAnalyzer.scheduleRecords.UnlockRecord;
 ...
 * @author ces
 */
public class UnlockRecordDialog extends javax.swing.JDialog {
	//[start] Atributos
	private ScheduleRecord record = null;
	//[end]
	
	//[start] Constructor
    public UnlockRecordDialog(java.awt.Frame parent, boolean modal, Set<String> transactions, Set<String> items) {
        super(parent, modal);
        initComponents();
    ...
    {
    	UnlockRecordDialog dialog = new UnlockRecordDialog(parent, true, transactions,items);
  ...
  //[end]
    ...
    private void btAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAceptarActionPerformed
    	...
    	{
	        record = new UnlockRecord((String)cbTransactions.getSelectedItem(),(String)cbItems.getSelectedItem());
