 ...
 * @author ces
 */
public class StartRecordDialog extends javax.swing.JDialog {
	...
	//[start] Constructor
    public StartRecordDialog(java.awt.Frame parent, boolean modal, Set<String> transactions) {
        super(parent, modal);
        initComponents();
    ...
    {
    	StartRecordDialog dialog = new StartRecordDialog(parent, true, transactions);
    ...
    private void btAceptarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btAceptarMouseClicked
    	...
    	{
	    	record = new StartRecord((String)cbTransactions.getSelectedItem());
	        this.setVisible(false);
    	}
