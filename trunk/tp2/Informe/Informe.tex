...
\begin{figure}[H]
\centering
\subfloat[Derecha 1]{\includegraphics[width=0.1\textwidth]{imagenes/inundPaso1.png}}
\qquad
\subfloat[Izquierda 1]{\includegraphics[width=0.1\textwidth]{imagenes/inundPaso2.png}}
\qquad
\subfloat[mas izq]{\includegraphics[width=0.1\textwidth]{imagenes/inundPaso3.png}}
\caption{fin de camino a}
\end{figure}
