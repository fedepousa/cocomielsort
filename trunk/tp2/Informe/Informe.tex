...
\begin{figure}[h]
\centering
\subfloat[Derecha 1]{\includegraphics[width=0.3\textwidth]{imagenes/paso1y2.png}}
\qquad
\subfloat[Izquierda 1]{\includegraphics[width=0.3\textwidth]{imagenes/pasosFinales.png}}
